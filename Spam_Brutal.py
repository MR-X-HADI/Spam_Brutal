...
def logo_taekyung():
    try:
        os.system("xdg-open https://www.facebook.com/profile.php?id=100054222010368")
        time.sleep(3)
        os.system("clear")
        print(f"""
...
\033[1;91m\033[1;41m\033[1;97m Author: By MR-X-HADI\033[;0m\033[1;91m\033[1;92m
""")
...
def put():
    ...
    try:
        ...
        mengetik("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m MASUKAN NOMOR TARGET \033[1;33m• \033[0m\033[1;30m]══════════════>")
        mr_am=input(f"\n\033[37m[\033[31m•\033[37m]\033[34m NOMOR TARGET\033[32m \033[36m:\033[37m\033[33m ")
        mengetik("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m BRUTAL PERMIUM \033[1;33m• \033[0m\033[1;30m]═════════════>")
        power_python=int(input(f"\033[37m[\033[31m•\033[37m]\033[32m Jumlah Spam \033[32m :\033[37m\033[33m "))
        print ("")
        for i in range(int(power_python)):
            ...
            if "call" in jag:
                mengetik(f"{W}[{G}✓{W}] Berhasil Mengirim Spammer √ {Y}{mr_am}")
            else:
                mengetik(f"{W}[{R}✓{W}] Berhasil Mengirim Spammer √ {Y}{mr_am}")
            time.sleep(1)
            ...
            if "cus" in Gwganz:
             ...
             mengetik(f"{W}[{G}B ✓{W}] Mengirim Spam Sms Ke virtex {Y}{mr_am}")
            time.sleep(2)
        ...
        sys.exit(f"{W}[{Y}!{W}] pelan tapi pasti !!!{abu}.....")
